...
/*const arr = [
  ...
  ["2º nível", 42, true],
  [
    ["3º nível - 1º item", "Elvis"],
    ["3º nível - 2º item", "Nelson"],
  ],
  [],
];
...
console.log(arr[2]); // Saída: [ [ '3º nível, 1º item', 'Elvis' ], [ '3º nível, 2º item', 'Nelson' ] ]
console.log(arr[2][0]); // Saída: [ '3º nível, 1º item', 'Elvis' ]
console.log(arr[2][1][1]); // Saída: 'Nelson'
*/
/*
